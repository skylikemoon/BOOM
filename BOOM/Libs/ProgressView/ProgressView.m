...
- (void)addArcBackColor{
    ...
    CGContextAddArc(contextRef, center.x, center.y, radius,M_PI-M_PI/3,2*M_PI*0.999, 0);
...
//    }else{
        ...
        float endAngle = 2*M_PI*_percent-30;//画不完整的圆
        ...
        CGContextAddArc(contextRef, center.x, center.y, radius,M_PI-M_PI/3,endAngle, 0);
